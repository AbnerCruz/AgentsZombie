...
const oldVisible=P.visibleChunks;
P.visibleChunks=function(camera,w,h){this.clampCamera(camera,w,h);const all=oldVisible.call(this,camera,w,h);return all.filter(c=>c&&this.chunkInBounds(c.cx,c.cy))};
