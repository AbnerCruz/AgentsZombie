...
P.getChunk=function(cx,cy){const had=this.peekChunk?.(cx,cy)||this.chunks?.get?.(`${cx},${cy}`)||this.touched?.get?.(`${cx},${cy}`),c=baseGetChunk.call(this,cx,cy);if(!had&&c&&!c.preview&&!c.void)invalidateRect(this,cx*G,cy*G,cx*G+G-1,cy*G+G-1);return c};
